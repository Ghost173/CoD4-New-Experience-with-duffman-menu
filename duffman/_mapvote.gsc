...
startMapvote()
{
	if(getentarray("player", "classname").size < 6 && getDvar("server_type") != "sd")
		setDvar( "sv_maprotation", "gametype dm map mp_killhouse gametype dm map mp_backlot gametype dm map mp_bog gametype dm map mp_cargoship gametype dm map mp_countdown gametype dm map mp_crash gametype dm map mp_crossfire gametype dm map mp_shipment gametype dm map mp_showdown" );
	else if(getDvar("server_type") != "sd")
		setDvar("sv_mapRotation" , "gametype dm map mp_killhouse gametype dm map mp_backlot gametype dm map mp_bog gametype dm map mp_cargoship gametype dm map mp_countdown gametype dm map mp_crash gametype dm map mp_crossfire gametype dm map mp_shipment gametype dm map mp_showdown");
	else 
		setDvar("sv_mapRotation" , "ggametype dm map mp_killhouse gametype dm map mp_backlot gametype dm map mp_bog gametype dm map mp_cargoship gametype dm map mp_countdown gametype dm map mp_crash gametype dm map mp_crossfire gametype dm map mp_shipment gametype dm map mp_showdown");
